-- Admin System Tables Migration (Fixed for existing tables)
...
DROP POLICY IF EXISTS "Anyone can view approved garage sales" ON garage_sales;
DROP POLICY IF EXISTS "Users can view their own garage sales" ON garage_sales;
DROP POLICY IF EXISTS "Users can create garage sales" ON garage_sales;
DROP POLICY IF EXISTS "Users can update their own pending garage sales" ON garage_sales;
DROP POLICY IF EXISTS "Admins can manage all garage sales" ON garage_sales;
...
DROP POLICY IF EXISTS "System can insert into activity log" ON admin_activity_log;
...
DROP TRIGGER IF EXISTS auto_create_admin_permissions ON profiles;
