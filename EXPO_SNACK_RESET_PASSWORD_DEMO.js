// YK Buddy - Password Reset Screen Demo for Expo Snack
      ...
      <View style={styles.container}>
        <View style={styles.successContainer}>
          ...
          <View style={styles.successActions}>
            <Button title="Back to Login" onPress={() => setEmailSent(false)} />
          ...
          <View style={styles.demoInfo}>
            <Text style={styles.demoText}>
              🎨 Success state demo - Tap "Back to Login" to return
            </Text>
          </View>
        </View>
      </View>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={styles.demoInfo}>
          <Text style={styles.demoText}>
            🎨 YK Buddy Password Reset Demo
          </Text>
          <Text style={styles.demoText}>
            Enter any valid email to see the success state!
          </Text>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
