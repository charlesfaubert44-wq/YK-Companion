    ...
    <div className="space-y-8 text-gray-300 leading-relaxed">
      ...
      <section className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
          <span className="text-2xl">🥶</span> The Reality
        </h2>
      ...
      {/* The Solution */}
      <section className="bg-gradient-to-br from-aurora-green/20 to-aurora-blue/20 backdrop-blur-sm rounded-xl p-6 border-2 border-aurora-green/30">
        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
          <span className="text-2xl">💡</span> Enter YK Buddy
        </h2>
      ...
      <div className="mt-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link href="/visiting">
            <button className="px-6 py-3 bg-gradient-to-r from-aurora-green to-aurora-blue text-white font-semibold rounded-lg hover:shadow-aurora transition-all transform hover:scale-105 text-sm">
              🧳 I'm Visiting
            </button>
          </Link>
          <Link href="/living">
            <button className="px-6 py-3 bg-gradient-to-r from-aurora-blue to-aurora-purple text-white font-semibold rounded-lg hover:shadow-glow transition-all transform hover:scale-105 text-sm">
              🏠 I Live Here
            </button>
          </Link>
          <Link href="/moving">
            <button className="px-6 py-3 bg-gradient-to-r from-aurora-purple to-aurora-pink text-white font-semibold rounded-lg hover:shadow-glow transition-all transform hover:scale-105 text-sm">
              📦 I'm Moving Here
            </button>
          </Link>
        </div>
