  ...
  return (
    <div className={`inline-block transition-all duration-500 hover:scale-110 ${className}`}>
      ...
      >
        ...
        <path
          d="M10 30 Q30 25 50 28 T90 30 L110 32 L110 45 Q90 42 70 45 T30 43 L10 45 Z"
          fill="url(#auroraGreen)"
          className="animate-aurora"
          opacity="0.7"
        />
        <path
          d="M10 35 Q35 32 55 35 T95 37 L110 38 L110 48 Q85 45 65 47 T25 46 L10 48 Z"
          fill="url(#auroraBlue)"
          className="animate-aurora-delayed"
          opacity="0.6"
        />
        <path
          d="M10 40 Q40 38 60 40 T100 42 L110 43 L110 52 Q80 49 60 51 T20 50 L10 52 Z"
        ...
        <path
          d="M10 60 L25 45 L40 55 L55 40 L70 50 L85 38 L100 48 L110 55 L110 110 L10 110 Z"
          fill="#1E293B"
          opacity="0.9"
        />
        <path
          d="M10 65 L30 50 L50 58 L70 45 L90 53 L110 60 L110 110 L10 110 Z"
          fill="#0F172A"
          opacity="0.8"
        />
  ...
  return (
    <div className={`inline-block transition-all duration-500 hover:scale-110 ${className}`}>
      ...
      >
        ...
        <path
          d="M10 60 L30 45 L50 55 L70 42 L90 50 L110 55 L110 110 L10 110 Z"
          fill="#334155"
          opacity="0.4"
        />
        ...
        <path
          d="M110 65 Q90 68 70 66 Q50 64 30 67 Q20 68 10 65 L10 75 Q20 73 30 75 Q50 77 70 75 Q90 73 110 75 Z"
          fill="url(#riverGradient)"
          opacity="0.7"
        />
        <path
          d="M110 75 Q85 77 60 76 Q35 75 10 77"
          stroke="#93C5FD"
          strokeWidth="0.5"
          opacity="0.5"
        />
        ...
        <g transform="translate(25, 20)">
          ...
          {/* Truck cab */}
          <path
            d="M22 40 L22 47 L32 47 L32 35 L26 35 L22 40 Z"
            fill="#DC2626"
            stroke="#991B1B"
            strokeWidth="2"
          />
          ...
          {/* Window */}
          <path
            d="M23 41 L23 45 L30 45 L30 37 L26 37 Z"
            fill="#BFDBFE"
            stroke="#3B82F6"
            strokeWidth="1"
          />
